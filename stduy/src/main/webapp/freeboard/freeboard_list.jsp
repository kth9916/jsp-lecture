...
<CENTER>
 ...
 <%   // Vector : 멀티스레드 환경에서 사용, 모든 메소드가 동기화 처리되어 있음. 
  ...
  int wheregroup=1;					 //현재 위치하는 그룹 
	...
	//go 변수 (페이지 번호) 를 넘겨 받어서 wheregroup, startpage, endpage 정보의 값을 알아낸다. 
  ...
  //gogroup 변수를 넘겨 받아서 startpage, endpadg, where (페이지 그룹의 첫번째 페이지 ) 
...
//  out.println ("끝 페이지 : " +  endpage + "<p>"); 
 ...
 //  out.println ("마지막 레코드 " + endrow + "<p>");
  ...
  // out.println ("토탈 페이지 그룹 " + totalgroup + "<p>");
   ...
   //현재 페지지에서 시작레코드, 마지막 레코드 까지 순환하면서 출력 
